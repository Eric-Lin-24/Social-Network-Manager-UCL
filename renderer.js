...
/**
 * Initialize sidebar collapse/expand behavior.
...
function restoreAppLayout() {
  ...
  appContainer.innerHTML = `
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <button class="nav-item active" data-view="dashboard" data-tooltip="Dashboard" onclick="navigateTo('dashboard')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button class="nav-item" data-view="documents" data-tooltip="Documents" onclick="navigateTo('documents')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button class="nav-item" data-view="scheduling" data-tooltip="Messages" onclick="navigateTo('scheduling')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button class="nav-item" data-view="calendar" data-tooltip="Calendar" onclick="navigateTo('calendar')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button class="nav-item" data-view="timeline" data-tooltip="Timeline" onclick="navigateTo('timeline')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button class="nav-item" data-view="people" data-tooltip="People" onclick="navigateTo('people')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button class="nav-item" data-view="settings" data-tooltip="Settings" onclick="navigateTo('settings')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  // Initialize sidebar toggle after layout is restored
  initSidebarToggle();
}
